...
export const DRIVER_LABELS: Record<string, string> = {
  ...
  ndvi_p10: "Driest vegetation patch (NDVI p10)",
  ndmi_mean: "Vegetation moisture (NDMI)",
  ndvi_anom: "Vegetation anomaly",
  tmax: "Max temperature",
  gust_max: "Peak wind gusts",
  et0_sum: "Evaporative demand (ET0)",
  ...
  crop_frac: "Cropland cover",
  builtup_frac: "Built-up area",
...
const DRIVER_PHRASES: Record<string, { up: string; down: string }> = {
  ...
  ndvi_p10: { up: "Patches of very dry vegetation", down: "Even, healthy vegetation" },
  ...
  gust_max: { up: "Strong gusts this week", down: "Calm conditions" },
  et0_sum: { up: "High evaporative demand", down: "Low evaporative demand" },
  ...
  crop_frac: { up: "Cropland fuels", down: "Little cropland" },
  builtup_frac: { up: "Built-up surroundings", down: "Away from built-up areas" },
